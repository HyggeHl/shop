package com.hygge.shop.shopcommon.codeGenerator;
...
public class CodeGenerator {
  ...
  public static void main(String[] args) {
    // 数据源配置
    FastAutoGenerator.create("jdbc:mysql://localhost:3306/shop?useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai&useSSL=false", "root", "123456")
      ...
      .strategyConfig(builder -> {
        builder.addInclude("t_ord_base") // 设置需要生成的表名 可边长参数“user”, “user1”
          ...
          .addTableFills(new Column("createdate", FieldFill.INSERT)) // 自动填充配置
